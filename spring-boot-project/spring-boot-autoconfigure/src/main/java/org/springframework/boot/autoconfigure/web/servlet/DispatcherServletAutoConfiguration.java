...
@Configuration
@ConditionalOnWebApplication(type = Type.SERVLET)// 启动自动配置条件1：必须是SERVLET WEB应用
@ConditionalOnClass(DispatcherServlet.class)// 启动自动配置条件2：ClassPath 下必须要有DispatcherServlet
@AutoConfigureAfter(ServletWebServerFactoryAutoConfiguration.class)//启动自动条件3：在ServletWebServerFactoryAutoConfiguration之后启动
